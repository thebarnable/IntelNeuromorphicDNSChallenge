...
class SpeakerModuleFromAudio(nn.Module):
    """Implements the Speaker Module in the model architecture

    Args:
        emb_size (int): The embedding dimensionality of the embedding layer.
        d_model (int): The model dimensionality.
    """
    def __init__(self, emb_size: int, d_model: int) -> None:
        super().__init__()
    ...
    def forward(self, x: Tensor) -> Tensor:
        """Given x as the [B,emb_size] embeddings of the speakers return after first embedding
