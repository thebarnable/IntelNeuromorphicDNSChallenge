""" 
Based on Intel DNS Challenge
https://github.com/IntelLabs/IntelNeuromorphicDNSChallenge/blob/main/snr.py
"""
...
def si_snr(target: Union[torch.tensor, np.ndarray],
  ...
  """Calculates SI-SNR estimate from target audio and estiamte audio. The
